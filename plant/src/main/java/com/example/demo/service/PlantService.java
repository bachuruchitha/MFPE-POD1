...
//			reorderrepo.update(reorderRulesTemplate.getRrid(),reorderRulesTemplate.getMaxQuantity(),reorderRulesTemplate.getMinQuantity(),reorderRulesTemplate.getReorderFrequency());
			updatePartReorder();
